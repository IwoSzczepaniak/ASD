...
Algorytm działa dopóki indeks i + aktualny max < n. Jeśli i + max > n, wtedy szukanie nowego maxa nie ma sensu,
bo z powodu ograniczonej wielkości tablicy żadne val_i nie może być już większe niż max.
...
2)Oczekiwana: nlogn + (n-max)*k, gdzie k to liczba nadzbiorów w tablicy L ----> Około O = nlogn + n
...
Cała tablica zawiera się w pierwszym elemencie
'''
